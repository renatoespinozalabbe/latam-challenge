...
def q3_time(file_path: str) -> List[Tuple[str, int]]:
    ...
    bucket_name = 'bucket-project-latam-challenge-q3-time'
    ...
    uri = 'gs://bucket-project-latam-challenge-q3-time/farmers-protest-tweets-2021-2-4.json'
    ...
    output = [(row.username, row.frequency) for row in results]
    return output